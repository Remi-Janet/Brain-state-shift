...
% load data
DATA = readtable('C:\Users\Neuroeconomics Lab\Documents\Articles\Gradients_Food\May_2023\August 2023\RJ_15_August\PNAS review\Data.csv');

% Main GLM (using the first 3 gradients)
mdl05 = fitglme(DATA,'RS ~ DeucHCvsNC * BMI + Age + gender + (1|Study) ');


% LOSO for RS predicted by HC-NC similarity shift
lmfunction = 'RS ~ DeucHCvsNC + BMI + Age + gender + (1|Study)';
RecapPermTest = DATA;
